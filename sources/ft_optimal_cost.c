...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/19 17:08:52 by mpazouki          #+#    #+#             */
/*   Updated: 2024/12/19 17:29:20 by mpazouki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int *cost, char **operation, int value) {
...
char *ft_optimal_cost(t_list *a, t_list *b) 
{
	...
	while (temp) {
		ft_calculate_cost(a, b, &cost, &operation, temp->content); 
		// Check all costs
